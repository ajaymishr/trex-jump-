...
function setup() {
  ...
  invisibleGround = createSprite(20,windowHeight-10,400,10);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if((touches.length>0) && trex.y >= windowHeight-40) {
      trex.velocityY = -12;
      touches=[];
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(windowWidth-windowWidth+80,windowHeight-80));
